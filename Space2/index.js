...
const material = new THREE.MeshPhongMaterial({
  ...
  // specularMap: loader.load("./textures/0_earthspec1k.jpg"),
  // bumpMap: loader.load("./textures/0_earthbump1k.jpg"),
  bumpScale: 0.04,
});
...
const lightsMat = new THREE.MeshBasicMaterial({
  // map: loader.load("./textures/0_earthlights1k.jpg"),
...
const cloudsMat = new THREE.MeshStandardMaterial({
  // map: loader.load("./textures/4_earthcloudmap.jpg"),
  transparent: true,
  opacity: 0.5,
  blending: THREE.AdditiveBlending,
  // alphaMap: loader.load('./textures/5_earthcloudmaptrans.jpg'),
  // alphaTest: 0.4,
});
