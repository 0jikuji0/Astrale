...
export default function Navbar() {
  ...
  return (
    <div
      className={`fixed top-0 left-0 w-full z-50 flex justify-center pointer-events-none transition-all duration-300 ${
        isScrolled ? "px-4 pt-6" : "px-0 pt-0"
      }`}
    >
      <div
        ...
        <div className="flex items-center justify-between gap-4">
          <div className="text-white text-lg font-semibold">
            <Link to="/" className="text-white text-lg font-semibold">
              <img src="/public/logo.webp" alt="Logo" width={50} height={50} />
            </Link>
          </div>
